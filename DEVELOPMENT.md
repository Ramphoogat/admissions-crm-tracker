...
```bash
git remote add encore encore://admissions-crm-tracker-2i22
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/admissions-crm-tracker-2i22/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/admissions-crm-tracker-2i22/settings/integrations/github)
